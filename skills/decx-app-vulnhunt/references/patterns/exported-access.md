...
## Non-obvious
- API < 17: Activity/Service/Receiver with `<intent-filter>` defaults `exported="true"`; API 31+ install **rejected** if filter-bearing component lacks explicit `exported`
